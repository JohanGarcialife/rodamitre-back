...
export const buscador = async (req, res) => {
  ...
  left join CLIENTES_DESC_PRODUCTOS cdp2 on cdp2.cli_id = @id and cdp2.cdp_activo = 'SI' and p.pre_id = cdp2.pre_id 
  left join CLIENTES_DESC_RUBROS cdr on cdr.cli_id= @id and cdr.cdr_activo = 'SI' and p.rup_id = cdr.rup_id 
  where  p.pre_codigo_fabrica like '%${req.body.p}%' and
  p.interior like '${req.body.interior}%'
  order by p.ventas_ult6meses DESC`);
    return res.json(result.recordset);
  }
  if (
  ...
  left join CLIENTES_DESC_RUBROS cdr on cdr.cli_id= @id and cdr.cdr_activo = 'SI' and p.rup_id = cdr.rup_id 
  where  p.pre_codigo_fabrica like '%${req.body.p}%' and
  p.interior like '${req.body.interior}%' and p.exterior like '${req.body.exterior}%'
  order by p.ventas_ult6meses DESC`);
    return res.json(result.recordset);
  }
  ...
  left join CLIENTES_DESC_RUBROS cdr on cdr.cli_id= @id and cdr.cdr_activo = 'SI' and p.rup_id = cdr.rup_id 
  where  p.pre_codigo_fabrica like '%${req.body.p}%' and
  p.interior like '${req.body.interior}%' and p.exterior like '${req.body.exterior}%' and p.altura like '${req.body.altura}%'
  order by p.ventas_ult6meses DESC`);
    return res.json(result.recordset);
  }
  ...
  left join CLIENTES_DESC_RUBROS cdr on cdr.cli_id= @id and cdr.cdr_activo = 'SI' and p.rup_id = cdr.rup_id 
  where
  p.exterior like '${req.body.exterior}%'
  order by p.ventas_ult6meses DESC`);
    return res.json(result.recordset);
  }
  if (
  ...
  left join CLIENTES_DESC_PRODUCTOS cdp2 on cdp2.cli_id = @id and cdp2.cdp_activo = 'SI' and p.pre_id = cdp2.pre_id 
  left join CLIENTES_DESC_RUBROS cdr on cdr.cli_id= @id and cdr.cdr_activo = 'SI' and p.rup_id = cdr.rup_id 
  where p.interior like '${req.body.interior}%' and p.exterior like '${req.body.exterior}%'
  order by p.ventas_ult6meses DESC`);
    return res.json(result.recordset);
  }
